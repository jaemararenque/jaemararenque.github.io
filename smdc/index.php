...
<body>
	<div id="page">
		<header>
			<div id="top">
				<div class="container">
					<p class="pull-left text-note hidden-xs"><i class="fa fa-phone"></i> Need Support? 0906 385 9195</p>
							...
							<div class="container">
								<div class="property-info">
									...
									<div class="property-thumb-info-content">
										...
										<p>SM Development Corporation commits itself to provide access to luxurious urban living through vertical villages perfectly integrated with a commercial retail environment, giving its residents access to a truly cosmopolitan lifestyle.</p>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-xs-6 col-md-3 animation">
							<div class="pgl-property featured-item">
								<div class="property-thumb-info">
									...
									<div class="property-thumb-info-content">
										<h3><a href="property-detail.html">1 Bedroom Unit</a></h3>
									...
									<div class="pgl-property">
										...
										<div class="property-thumb-info">
											...
											<div class="amenities clearfix">
												<ul class="pull-left">
													<li><strong>Price Range:</strong> 2.8M - 3M</li>
												</ul>
											</div>
										</div>
										</a>
							...
							<div class="row">
								<div class="col-xs-4 animation">
									<div class="pgl-property">
										<div class="property-thumb-info">
											<div class="property-thumb-info-image">
												<img alt="" class="img-responsive" src="images/properties/property-4.jpg?v=2">
												<span class="property-thumb-info-label">
								...
								<div class="col-xs-4 animation">
									<div class="pgl-property">
										<div class="property-thumb-info">
											<div class="property-thumb-info-image">
												<img alt="" class="img-responsive" src="images/properties/property-5.jpg?v=2">
												<span class="property-thumb-info-label">
													<span class="label price">$358,000</span>
												</span>
											</div>
								...
								<div class="col-xs-4 animation">
									<div class="pgl-property">
										<div class="property-thumb-info">
											<div class="property-thumb-info-image">
												<img alt="" class="img-responsive" src="images/properties/property-6.jpg?v=2">
												<span class="property-thumb-info-label">
													<span class="label price">$358,000</span>
												</span>
											</div>
								...
								<div class="row pgl-midnarrow-row">
									<div class="col-xs-4">
										<div class="img-thumbnail-medium">
											<a href="agentprofile.html"><img src="images/agents/temp-agent.png" class="img-responsive" style="width: 270px;" alt=""></a>
										</div>
									</div>
									<div class="col-xs-8">
		...
		<footer class="pgl-footer">
			<div class="container">
				...
				<div class="pgl-copyrights">
					<p>Copyright © 2017 Iskolar Creatives</p>
				</div>
			</div>
		</footer>
		<!-- End footer -->
