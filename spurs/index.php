...
<!-- Mirrored from demo.nrgthemes.com/projects/nrghosts/index-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jan 2018 10:56:06 GMT -->
<head>
	<meta http-equiv="content-type" content="text/html; charset=utf-8" />
    <meta name="format-detection" content="telephone=no" />
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
    <script src="../../cdn-cgi/apps/head/1sZCq7BECvDgKDoo_5GdSy-HJEo.js"></script><link href="css/bootstrap.min.css" rel="stylesheet" type="text/css" />
...
dynx_totalvalue: '19 USD',
};
</script>
<script type="text/javascript">
/* <![CDATA[ */
var google_conversion_id = 949581568;
...
<img height="1" width="1" style="border-style:none;" alt="" src="http://googleads.g.doubleclick.net/pagead/viewthroughconversion/949581568/?value=0&amp;guid=ON&amp;script=0"/>
                ...
                <div class="scrollable-container">
                            ...
                            <div class="menu-entry active">
                                ...
                                <div class="submenu">
                                    <div>
                                        ...
                                        <a class="active" href="index-1.html">Style 2</a>
                    ...
                    <div class="header-right">
                        <div class="header-inline-entry">
                            <div><span class="glyphicon glyphicon-time"></span><b>24/7</b> Custtomer Support </div>
    ...
    <div class="subheader">
        <div class="container-fluid">
            <a id="subheader-logo" href="index.html"><img src="img/logo.png" alt="" /></a>
            <div class="subheader-content">
                <div class="subheader-left">
                    ...
                    <a class="scroll-to-link subheader-link" data-rel="4">Testimonials</a>
                    <a class="scroll-to-link subheader-link" data-rel="5">FAQ's</a>
                    <a class="scroll-to-link subheader-link" data-rel="6">Registration</a>
                    <a class="scroll-to-link subheader-link" data-rel="7">Guarantee</a>
                </div>
    ...
    <div id="content-wrapper">
        ...
        <div class="blocks-container">
            ...
            <div class="block type-10 style-1">
                <img class="center-image" src="img/background-6.jpg" />
                <div class="main-banner-height">
                    <div class="swiper-container" data-autoplay="0" data-loop="1" data-speed="500" data-center="0" data-slides-per-view="1">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide"> 
                                <img class="center-image" src="img/background-7.jpg" />
                                <div class="container">
                                    <div class="slide-container">
                                        <div class="slide-block nopadding col-sm-6">
                            ...
                            <div class="swiper-slide"> 
                                <img class="center-image" src="img/background-8.jpg" />
                                <div class="container">
                                    <div class="slide-container">
                                        <div class="slide-block nopadding col-sm-6">
                            ...
                            <div class="swiper-slide"> 
                                <img class="center-image" src="img/background-9.jpg" />
                                <div class="container">
                                    <div class="slide-container">
            ...
            <!-- BLOCK "TYPE 12" -->
            <div class="block type-12 scroll-to-block" data-rel="1">
                <div class="container">
                    ...
                    <div class="tabs-wrapper wow fadeInUp">

                        <div class="tabs-switch-box">
                            <div class="tabs-desktop">
                                <div class="active">Secure Data</div>
                                <div>Data Enctyption</div>
                                <div>Data Stotage</div>
                                <div>Statistics</div>
                            </div>
                            <div class="tabs-select-text"><span class="text">Secure Data</span><span class="glyphicon glyphicon-chevron-down"></span></div>
                            <select>
                                <option>Secure Data</option>
                                <option>Data Enctyption</option>
                                <option>Data Stotage</option>
                        ...
                        <div class="tabs-container" style="display: block;">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="icon-entry col-sm-6">
                                            <img class="img-circle" src="img/icon-53.png" alt="" />
                                        ...
                                        <div class="icon-entry col-sm-6">
                                            <img class="img-circle" src="img/icon-54.png" alt="" />
                                            <h3 class="title">Data Monitoring</h3>
                                            <div class="text">Duis posuere blandit orci sed tincidunt. Curabitur porttitor nisi ac nunc ornare, in fringilla nisl blandit.</div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="icon-entry col-sm-6">
                                            <img class="img-circle" src="img/icon-55.png" alt="" />
                                            <h3 class="title">Data Optimization</h3>
                                            <div class="text">Duis posuere blandit orci sed tincidunt. Curabitur porttitor nisi ac nunc ornare, in fringilla nisl blandit.</div>
                                        </div>
                                        <div class="icon-entry col-sm-6">
                                            <img class="img-circle" src="img/icon-56.png" alt="" />
                                ...
                                <div class="col-md-6">
                                    <img class="big-image-entry" src="img/slider-image-4.png" alt="" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tabs-container">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="icon-entry col-sm-6">
                                            <img class="img-circle" src="img/icon-47.png" alt="" />
                                            <h3 class="title">Data Analysis</h3>
                                            <div class="text">Duis posuere blandit orci sed tincidunt. Curabitur porttitor nisi ac nunc ornare, in fringilla nisl blandit.</div>
                                        </div>
                                        <div class="icon-entry col-sm-6">
                                            <img class="img-circle" src="img/icon-48.png" alt="" />
                                            <h3 class="title">Data Monitoring</h3>
                                            <div class="text">Duis posuere blandit orci sed tincidunt. Curabitur porttitor nisi ac nunc ornare, in fringilla nisl blandit.</div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="icon-entry col-sm-6">
                                            <img class="img-circle" src="img/icon-49.png" alt="" />
                                            <h3 class="title">Data Optimization</h3>
                                            <div class="text">Duis posuere blandit orci sed tincidunt. Curabitur porttitor nisi ac nunc ornare, in fringilla nisl blandit.</div>
                                        </div>
                                        <div class="icon-entry col-sm-6">
                        ...
                        <div class="tabs-container">
                            <div class="row">
                                <div class="col-md-6">
                                    <img class="big-image-entry" src="img/slider-image-2.png" alt="" />
                                </div>
                                <div class="col-md-6">
                                    <img class="big-image-entry" src="img/slider-image-1.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="block type-2 scroll-to-block" data-rel="2">
                <div class="container">
                    ...
                    <div class="row wow fadeInDown">
                        <div class="block-header col-md-6 col-md-offset-3 col-sm-12 col-sm-offset-0">
                            <h2 class="title">Popular Plans</h2>
                            <div class="text">Integer faucibus, dui quis pellentesque vestibulum, nulla ante aliquet turpis, in consectetur ex dui vitae erat in eleifend eros</div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="price-entry col-sm-4 col-xs-12 wow fadeInLeft" data-wow-delay="0.3s">
                            <img class="icon img-circle" src="img/icon-47.png" alt="" />
                            <div class="entry">
                                <div class="top">
                                    <div class="cell-view">
                        ...
                        <div class="price-entry col-sm-4 col-xs-12 wow fadeInUp" data-wow-delay="0.4s">
                            <img class="icon img-circle" src="img/icon-48.png" alt="" />
                            <div class="entry">
                                <div class="top">
                                    <div class="cell-view">
                        ...
                        <div class="price-entry col-sm-4 col-xs-12 wow fadeInRight" data-wow-delay="0.3s">
                            <img class="icon img-circle" src="img/icon-49.png" alt="" />
                            <div class="entry">
                                <div class="top">
                                    <div class="cell-view">
            ...
            <!-- BLOCK "TYPE 3" - MODIFICATION WITH SLIDER ENABLED -->
            <div class="block type-3 style-1 scroll-to-block" data-rel="3">
                <div class="container">
                    ...
                    <div class="wow fadeInUp">
                        <div class="swiper-container" data-autoplay="0" data-loop="0" data-speed="500" data-center="0" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="4" data-lg-slides="4">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"> 
                                    <div class="icon-entry">
                                        <img class="img-circle" src="img/icon-57.png" alt=""/>
                                        <div class="content">
                                ...
                                <div class="swiper-slide"> 
                                    <div class="icon-entry">
                                        <img class="img-circle" src="img/icon-58.png" alt=""/>
                                        <div class="content">
                                ...
                                <div class="swiper-slide"> 
                                    <div class="icon-entry">
                                        <img class="img-circle" src="img/icon-59.png" alt=""/>
                                        <div class="content">
                                            <h3 class="title">Easy Start</h3>
                                            <div class="text">Duis posuere blandit orci sed tincidunt. Curabitur porttitor nisi ac nunc ornare, in fringilla nisl blandit.</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide"> 
                                    <div class="icon-entry">
                                        <img class="img-circle" src="img/icon-60.png" alt=""/>
                                        <div class="content">
            ...
            <!-- BLOCK "TYPE 6" - MODIFICATION WITH FULL-WIDTH TESTIMONIALS -->
            <div class="block type-6 style-1 scroll-to-block" data-rel="4">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="testimonials-wrapper wow fadeInUp">
                                <div class="row">
                                    <div class="testimonials-container col-md-6 col-md-offset-3 col-sm-12 col-sm-offset-0">
                                        <div class="swiper-container connected-to-bottom-swiper" data-autoplay="0" data-loop="0" data-speed="500" data-center="0" data-slides-per-view="1">
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide default-active"> 
                                                    <blockquote>
                                                        <p>Nulla ut ante vel lorem tempus lobortis. Sed quam metus, faucibus et pulvinar ut, volutpat ut orci. Nulla ornare ex lectus. Integer non neque sed eros sollicitudin congue. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Sed quam metus, faucibus et pulvinar ut, volutpat ut orci.</p>
                                                        <footer><cite>Dorian Gray</cite>, Ceo Google Corp</footer>
                                                    </blockquote>
                                ...
                                <div class="swiper-container connected-to-top-swiper" data-autoplay="0" data-loop="0" data-speed="500" data-center="1" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="3" data-md-slides="7" data-lg-slides="9">
                                    <div class="swiper-wrapper testimonials-icons">
                                        <div class="entry swiper-slide"> 
                                            <div><img src="img/icon-32.png" alt="" /></div>
                                        </div>
                                        <div class="entry swiper-slide"> 
                                            <div><img src="img/icon-33.png" alt="" /></div>
                                        </div>
                                        <div class="entry swiper-slide"> 
                                            <div><img src="img/icon-34.png" alt="" /></div>
                                        </div>
                                        <div class="entry swiper-slide"> 
                                            <div><img src="img/icon-35.png" alt="" /></div>
                                        </div>
                                        <div class="entry swiper-slide default-active"> 
                                            <div><img src="img/icon-36.png" alt="" /></div>
                                        </div>
                                        <div class="entry swiper-slide"> 
                                            <div><img src="img/icon-37.png" alt="" /></div>
                                        </div>
                                        <div class="entry swiper-slide"> 
                                            <div><img src="img/icon-38.png" alt="" /></div>
                                        </div>
                                        <div class="entry swiper-slide"> 
                                            <div><img src="img/icon-39.png" alt="" /></div>
                                        </div>
                                        <div class="entry swiper-slide"> 
                                            <div><img src="img/icon-32.png" alt="" /></div>
                                        </div>
            ...
            <!-- BLOCK "TYPE 6" -->
            <div class="block type-6 scroll-to-block" data-rel="5">
                <div class="container">
            ...
            <div class="block type-13 scroll-to-block" data-rel="6">
                <div class="container">
                    ...
                    <div class="circle-slide-box wow fadeInUp">
                        <div class="swiper-container connected-to-bottom-swiper" data-autoplay="0" data-loop="0" data-speed="500" data-center="1" data-slides-per-view="responsive" data-xs-slides="3" data-sm-slides="3" data-md-slides="5" data-lg-slides="5">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"> 
                                    <img class="img-circle" src="img/icon-62.png" alt="" />
                                </div>
                                <div class="swiper-slide"> 
                                    <img class="img-circle" src="img/icon-63.png" alt="" />
                                </div>
                                <div class="swiper-slide default-active"> 
                                    <img class="img-circle" src="img/icon-61.png" alt="" />
                                </div>
                                <div class="swiper-slide"> 
                                    <img class="img-circle" src="img/icon-64.png" alt="" />
                                </div>
                                <div class="swiper-slide"> 
                                    <img class="img-circle" src="img/icon-65.png" alt="" />
                                </div>
                            </div>
                            <div class="pagination"></div>
                        </div>
                    ...
                    <div class="circle-description-slide-box row">
                            ...
                            <div class="swiper-container connected-to-top-swiper" data-autoplay="0" data-loop="0" data-speed="500" data-center="0" data-slides-per-view="1">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide"> 
                                        <div class="col-md-6 col-md-offset-3 col-sm-12 col-sm-offset-0">
                                            <h3 class="title">1. Choose A Plan</h3>
                                            <div class="text">Aenean pharetra egestas nulla eu ultrices. Donec luctus est molestie, pulvinar ante eget, efficitur augue. Donec euismod accumsan magna bibendum pulvinar. Aliquam erat volutpat. Fusce placerat ligula quis justo viverra venenatis.</div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide"> 
                                        <div class="col-md-6 col-md-offset-3 col-sm-12 col-sm-offset-0">
                                            <h3 class="title">2. Choose A Plan</h3>
                                            <div class="text">Aenean pharetra egestas nulla eu ultrices. Donec luctus est molestie, pulvinar ante eget, efficitur augue. Donec euismod accumsan magna bibendum pulvinar. Aliquam erat volutpat. Fusce placerat ligula quis justo viverra venenatis.</div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide default-active"> 
                                        <div class="col-md-6 col-md-offset-3 col-sm-12 col-sm-offset-0">
                                            <h3 class="title">3. Choose A Plan</h3>
                                            <div class="text">Aenean pharetra egestas nulla eu ultrices. Donec luctus est molestie, pulvinar ante eget, efficitur augue. Donec euismod accumsan magna bibendum pulvinar. Aliquam erat volutpat. Fusce placerat ligula quis justo viverra venenatis.</div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide"> 
                                        <div class="col-md-6 col-md-offset-3 col-sm-12 col-sm-offset-0">
                                            <h3 class="title">4. Choose A Plan</h3>
                                            <div class="text">Aenean pharetra egestas nulla eu ultrices. Donec luctus est molestie, pulvinar ante eget, efficitur augue. Donec euismod accumsan magna bibendum pulvinar. Aliquam erat volutpat. Fusce placerat ligula quis justo viverra venenatis.</div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide"> 
                                        <div class="col-md-6 col-md-offset-3 col-sm-12 col-sm-offset-0">
                                            <h3 class="title">5. Choose A Plan</h3>
                                            <div class="text">Aenean pharetra egestas nulla eu ultrices. Donec luctus est molestie, pulvinar ante eget, efficitur augue. Donec euismod accumsan magna bibendum pulvinar. Aliquam erat volutpat. Fusce placerat ligula quis justo viverra venenatis.</div>
                                        </div>
                                    </div>
                                </div>
            ...
            <!-- BLOCK "TYPE 11" -->
            <div class="block type-11 scroll-to-block" data-rel="7">
                <div class="container">
                    ...
                    <div class="row wow fadeInDown">
                        ...
                        <div class="row text-image-box">
                            <div class="col-sm-6 col-sm-push-6 wow fadeInRight">
                                <div class="image-wrapper"><img src="img/slider-image-5.png" alt=""/></div>
                            </div>
                            <div class="col-sm-6 col-sm-pull-6 wow fadeInLeft">
                                <div class="cell-view">
                                    ...
                                    <a class="button" href="host-faq.html">Have A Question?</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row text-image-box">
                            <div class="col-sm-6 wow fadeInLeft">
                                <div class="image-wrapper"><img src="img/slider-image-6.png" alt=""/></div>
                            </div>
                            <div class="col-sm-6 wow fadeInRight">
                                <div class="cell-view">
                                    <h3 class="title">45 Day Guarantee</h3>
                                    <div class="text"><p>Duis eget purus non est pellentesque egestas. Maecenas venenatis ante urna, tincidunt viverra quam mattis at. Pellentesque tempor vehicula elit, quis tincidunt lectus laoreet eget.</p></div>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h4 class="subtitle"><img src="img/icon-51.png" alt="" />Aenean Fermentum</h4>
                                            <div class="subtext"><p>Duis posuere blandit orci sed tincidunt. Curabitur porttitor nisi ac nunc ornare, in fringilla nisl blandit.</p></div>
                                        </div>
                                        <div class="col-sm-6">
                                            <h4 class="subtitle"><img src="img/icon-52.png" alt="" />Maecenas Venenatis</h4>
                                            <div class="subtext"><p>Duis posuere blandit orci sed tincidunt. Curabitur porttitor nisi ac nunc ornare, in fringilla nisl blandit.</p></div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row text-image-box">
                            <div class="col-sm-6 col-sm-push-6 wow fadeInRight">
                                <div class="image-wrapper"><img src="img/slider-image-7.png" alt=""/></div>
                            </div>
                            <div class="col-sm-6 col-sm-pull-6 wow fadeInLeft">
                                <div class="cell-view">
                                    ...
                                    <div class="text">
                                        ...
                                        <ul>
                                            <li>Maecenas in augue eu dui cursus rutrum.</li>
                                            <li>Quisque pretium tellus sit amet condimentum laoreet.</li>
                                            <li>Quisque a lacus ut sem pellentesque pellentesque.</li>
                                            <li>Praesent fermentum mauris eget massa feugiat, sed vestibulum leo feugiat.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="footer-line-entry col-md-3 col-sm-6 col-xs-12">
                        ...
                        <div class="content">
                            <div class="cell-view"><a href="http://demo.nrgthemes.com/cdn-cgi/l/email-protection#7605030606190402361804111e1905025815191b"><span class="__cf_email__" data-cfemail="a3d0d6d3d3ccd1d7e3cdd1c4cbccd0d78dc0ccce">[email&#160;protected]</span></a></div>
                        </div>
                    </div>
                    <div class="footer-line-entry col-md-3 col-sm-6 col-xs-12">
...
<!-- Mirrored from demo.nrgthemes.com/projects/nrghosts/index-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jan 2018 10:56:13 GMT -->
</html>
